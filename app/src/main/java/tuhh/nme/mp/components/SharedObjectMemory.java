...
/**
 * This class allows to store data that can be accesses from different processes in the application.
 *
...
{
    /**
     * Instantiates a new SharedObjectMemory object.
     */
    ...
    /**
     * Retrieves the stored objects and takes it off from the memory.
     *
